...
- 提交阿尔法时，建议选择带有主题的，multiplier 在 1.2 以下的基本无增益。
...
- 可从 turnover、Decay、delay 等多个角度选择阿尔法，还可根据 universe size、self correlation 等指标筛选。
- 成为 grandmaster 后，可根据作者的 product、alpha yield rate per quarter 等筛选阿尔法，可通过加负号、使用 operator 或 rank 选择不同排名的阿尔法。
...
### Q: 提交阿尔法时对 multiplier 有什么要求？
A: 提交阿尔法时，建议选择带有主题的，multiplier 在 1.2 以下的基本无增益。
...
### Q: 可以从哪些角度选择阿尔法？
A: 可从 turnover、Decay、delay 等多个角度选择阿尔法，还可根据 universe size、self correlation 等指标筛选。

### Q: 成为 grandmaster 后如何筛选阿尔法？
A: 成为 grandmaster 后，可根据作者的 product、alpha yield rate per quarter 等筛选阿尔法，可通过加负号、使用 operator 或 rank 选择不同排名的阿尔法。

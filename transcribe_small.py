#!/usr/bin/env python3
"""Transcribe audio with faster-whisper (small model), output .auc.md format."""
from pathlib import Path

from faster_whisper import WhisperModel

AUDIO_PATH = Path("/Users/cony.zhangbjgmail.com/dev/wq-brain/knowledge/audio/带你读论文第三课_2025_01_15.wav")
